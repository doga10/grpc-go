...
type UserRequest struct {
	...
	Name     string `protobuf:"bytes,1,opt,name=name,proto3" jwt:"name,omitempty"`
	Email    string `protobuf:"bytes,2,opt,name=email,proto3" jwt:"email,omitempty"`
	Password string `protobuf:"bytes,3,opt,name=password,proto3" jwt:"password,omitempty"`
}
...
type UserResponse struct {
	...
	Id        string `protobuf:"bytes,1,opt,name=id,proto3" jwt:"id,omitempty"`
	Name      string `protobuf:"bytes,2,opt,name=name,proto3" jwt:"name,omitempty"`
	Email     string `protobuf:"bytes,3,opt,name=email,proto3" jwt:"email,omitempty"`
	Password  string `protobuf:"bytes,4,opt,name=password,proto3" jwt:"password,omitempty"`
	CreatedAt string `protobuf:"bytes,5,opt,name=created_at,jwt=createdAt,proto3" jwt:"created_at,omitempty"`
	UpdatedAt string `protobuf:"bytes,6,opt,name=updated_at,jwt=updatedAt,proto3" jwt:"updated_at,omitempty"`
}
...
var file_user_message_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x67, 0x6f, 0x6c, 0x61, 0x6e,
	0x67, 0x22, 0x53, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0xa2, 0x01, 0x0a, 0x0c, 0x55, 0x73, 0x65, 0x72, 0x52,
	...
	0x52, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x32, 0x52, 0x0a, 0x0b, 0x55,
	0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x43, 0x0a, 0x0a, 0x43, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x12, 0x18, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e,
	0x67, 0x6f, 0x6c, 0x61, 0x6e, 0x67, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x19, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x67, 0x6f, 0x6c, 0x61, 0x6e, 0x67,
...
var file_user_message_proto_goTypes = []interface{}{
	(*UserRequest)(nil),  // 0: grpc.golang.UserRequest
	(*UserResponse)(nil), // 1: grpc.golang.UserResponse
}
var file_user_message_proto_depIdxs = []int32{
	0, // 0: grpc.golang.UserService.CreateUser:input_type -> grpc.golang.UserRequest
	1, // 1: grpc.golang.UserService.CreateUser:output_type -> grpc.golang.UserResponse
...
func (c *userServiceClient) CreateUser(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/grpc.golang.UserService/CreateUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserService_CreateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.golang.UserService/CreateUser",
	}
...
var _UserService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "grpc.golang.UserService",
